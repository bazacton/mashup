 ...
 */
if ( ! class_exists( 'mashup_facebook_module' ) ) {

    class mashup_facebook_module extends WP_Widget {
        /**
        ...
        public function __construct() {
            ...
            parent::__construct(
                    'mashup_facebook_module', // Base ID
                    esc_html( mashup_var_theme_text_srt( 'mashup_var_facebook' ) ), // Name
                    array( 'classname' => 'facebok_widget', 'description' => esc_html( mashup_var_theme_text_srt( 'mashup_var_facebook_desc' ) ), ) // Args
            );
        }
        ...
        function form( $instance ) {
            ...
            ?>
            <p>
                <label for="<?php echo esc_attr( $this->get_field_id( 'title' ) ); ?>"><?php echo esc_html( mashup_var_theme_text_srt( 'mashup_var_facebook_title' ) ); ?>
            ...
            <p>
                <label for="<?php echo esc_attr( $this->get_field_id( 'pageurl' ) ); ?>"><?php echo esc_html( mashup_var_theme_text_srt( 'mashup_var_facebook_url' ) ); ?> 
                    <input class="upcoming" id="<?php echo mashup_allow_special_char( $this->get_field_id( 'pageurl' ) ); ?>" size='40' name="<?php echo esc_attr( $this->get_field_name( 'pageurl' ) ); ?>" type="text" value="<?php echo esc_attr( $pageurl ); ?>" />
                    <br />
                    <small><?php echo esc_html( mashup_var_theme_text_srt( 'mashup_var_facebook_profile_url' ) ); ?> http://www.facebook.com/profilename OR <br />
                        https://www.facebook.com/pages/wxyz/123456789101112 </small><br />
                </label>
            </p>
            <p>
                <label for="<?php echo $this->get_field_id( 'width' ); ?>"><?php echo esc_html( mashup_var_theme_text_srt( 'mashup_var_facebook_width' ) ); ?> 
            ...
            <p>
                <label for="<?php echo $this->get_field_id( 'likebox_height' ); ?>"><?php echo esc_html( mashup_var_theme_text_srt( 'mashup_var_facebook_lightbox_height' ) ); ?> 
            ...
            <p>
                <label for="<?php echo esc_attr( $this->get_field_id( 'hide_cover' ) ); ?>"><?php echo esc_html( mashup_var_theme_text_srt( 'mashup_var_facebook_hide_cover' ) ); ?> 
            ...
            <p>
                <label for="<?php echo esc_attr( $this->get_field_id( 'showfaces' ) ); ?>"><?php echo esc_html( mashup_var_theme_text_srt( 'mashup_var_facebook_show_faces' ) ); ?> 
            ...
            <p>
                <label for="<?php echo esc_attr( $this->get_field_id( 'show_posts' ) ); ?>"><?php echo esc_html( mashup_var_theme_text_srt( 'mashup_var_facebook_show_post' ) ); ?> 
        ...
        function widget( $args, $instance ) {
            ...
            $output .= '>';
            $output .= '</div></div>';
            echo mashup_allow_special_char( $output );
        }
    ...
    add_action('widgets_init', function() {
        register_widget('mashup_facebook_module');
    });
