...
if ( ! class_exists('mashup_mega_custom_menu') ) {

	class mashup_mega_custom_menu {
		/* --------------------------------------------*
		 * Constructor
		 * -------------------------------------------- */
		...
		function __construct() {
			...
			add_filter('wp_setup_nav_menu_item', array( $this, 'mashup_mega_add_custom_nav_fields' ));
			// save menu custom fields
			add_action('wp_update_nav_menu_item', array( $this, 'mashup_cs_mega_update_custom_nav_fields' ), 10, 3);
			// edit menu walker
			add_filter('wp_edit_nav_menu_walker', array($this, 'mashup_mega_edit_walker'), 10, 2);
		}
		 ...
		 * @return      void
		 */
		function mashup_mega_add_custom_nav_fields($menu_item) {
		 ...
		 * @return      void
		 */
		function mashup_cs_mega_update_custom_nav_fields($menu_id, $menu_item_db_id, $args) {
         ...
         * @return      void
         */
        function mashup_mega_edit_walker($walker, $menu_id) {
...
$mashup_mega_custom_menu = new mashup_mega_custom_menu();
