...
$var_arrays = array('mashup_var_fonts_subsets');
$fonts_array_global_vars = MASHUP_VAR_GLOBALS()->globalizing($var_arrays);
extract($fonts_array_global_vars);
if (!function_exists('mashup_var_get_google_init_arrays')) {

    function mashup_var_get_google_init_arrays() {
        ...
        update_option('mashup_var_font_list', $font_list_init);
        update_option('mashup_var_font_attribute', $font_atts_int);
    }

}
$mashup_var_fonts_subsets = array(
