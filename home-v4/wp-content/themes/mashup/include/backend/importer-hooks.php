...
add_action( 'mashup_import_wp_data', 'mashup_import_wp_data_handle' );
if ( ! function_exists( 'mashup_import_wp_data_handle' ) ) {
	/**
	 ...
	 */
	function mashup_import_wp_data_handle( $obj ) {
		...
		if ( ! class_exists( 'WP_Import' ) ) {
			require_once $obj->mashup_importer_class_path;
		}
...
add_action( 'mashup_import_theme_options', 'mashup_import_wp_options_handle' );
if ( ! function_exists( 'mashup_import_wp_options_handle' ) ) {
	/**
	 * Import Theme Options
	 *
	 * @param CS_Data_Importer $obj An instance of CS_Data_Importer class which contains different configurations.
	 */
	function mashup_import_wp_options_handle( $obj ) {
		global $wp_filesystem;
		$theme_options = $wp_filesystem->get_contents( $obj->theme_options_data_path );
		$mashup_theme_skin = json_decode( $theme_options, true );
		update_option( 'mashup_var_options', $mashup_theme_skin );
...
add_action( 'mashup_import_menus_and_locations', 'mashup_import_menus_and_locations_handle' );
if ( ! function_exists( 'mashup_import_menus_and_locations_handle' ) ) {
	/**
	 * Set Menu's locations
	 *
	 * @param CS_Data_Importer $obj An instance of CS_Data_Importer class which contains different configurations.
	 */
	function mashup_import_menus_and_locations_handle( $obj ) {
...
add_action( 'mashup_import_setup_pages', 'mashup_import_setup_pages_handle' );
if ( ! function_exists( 'mashup_import_setup_pages_handle' ) ) {
	/**
	 * Set homepage for site
	 *
	 * @param CS_Data_Importer $obj An instance of CS_Data_Importer class which contains different configurations.
	 */
	function mashup_import_setup_pages_handle( $obj ) {
...
add_action( 'mashup_import_rev_sliders', 'mashup_import_rev_slider_handle' );
if ( ! function_exists( 'mashup_import_rev_slider_handle' ) ) {
	/**
	 * Import Revolution Slider content using Revolution slider's importer
	 *
	 * @param CS_Data_Importer $obj An instance of CS_Data_Importer class which contains different configurations.
	 */
	function mashup_import_rev_slider_handle( $obj ) {
		if ( class_exists( 'RevSlider' ) ) {
			global $wp_filesystem;
			$slider_data = $wp_filesystem->get_contents( $obj->sliders_data_path );
			$mashup_upload_dir = wp_upload_dir();
			$slider_file = $mashup_upload_dir['path'] . '/slider_data_' . time() . '.zip';
...
add_action( 'mashup_import_widgets', 'mashup_import_widgets_handle' );
if ( ! function_exists( 'mashup_import_widgets_handle' ) ) {
	/**
	 * Import Widgets
	 *
	 * @param CS_Data_Importer $obj An instance of CS_Data_Importer class which contains different configurations.
	 */
	function mashup_import_widgets_handle( $obj ) {
		if ( class_exists( 'mashup_var_widget_data' ) ) {
			mashup_var_widget_data::mashup_import_widget_data( $obj->widget_data_path );
			$obj->action_return = true;
		} else {
			$obj->action_return = false;
		}
