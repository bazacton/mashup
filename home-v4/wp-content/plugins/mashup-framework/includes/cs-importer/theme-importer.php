...
add_action( 'admin_menu', 'mashup_theme' );
if ( ! function_exists( 'mashup_theme' ) ) {

    /**
     * Add Importer item to WP Admin Dashboard sidebar menu
     */
    function mashup_theme() {
        add_theme_page( 'Import Demo Data', __( 'Import Demo Data', 'mashup' ), 'read', 'mashup_demo_importer', 'mashup_demo_importer' );
    }
...
if ( ! function_exists( 'mashup_demo_importer' ) ) {

    /**
     * Output GUI for Demo Importer
     */
    function mashup_demo_importer() {//delete_option( 'item_purchase_code_verification' );die();
        $theme_id = THEME_ENVATO_ID;
        $theme_name = THEME_NAME;

        if ( function_exists( 'mashup_get_server_requirements' ) ) {
            $server_requirements = mashup_get_server_requirements();
        } else {
            wp_die( __( 'Server requirements not available.', 'mashup' ) );
        }

        if ( function_exists( 'mashup_get_plugin_requirements' ) ) {
            $plugin_requirements = mashup_get_plugin_requirements();
        } else {
            wp_die( __( 'Plugin reuirements not available.', 'mashup' ) );
        }

        if ( function_exists( 'mashup_get_demo_data_structure' ) ) {
            $demo_data_structure = mashup_get_demo_data_structure();
        } else {
            wp_die( __( 'Demo data structure not available.', 'mashup' ) );
        }
        ?>
        <div style="margin-left: 15px;">
            <h2><?php _e( 'Import Demo Data', 'mashup' ); ?></h2>
            <form method="post">
                <div class="importer-wrapper container custom-importer">
                    ...
                    if ( is_wp_error( $response ) ) {
                        wp_die( '<h2 class="error">' . __( 'Sorry, It seems that API server is not available. Please, contact theme owner and report this issue.', 'mashup' ) . '</h2>' );
                    }
                    ?>
                    <div class="importer-steps-wrapper row">
                        <div class="step step-1 col-lg-3 col-md-3 col-sm-12 active">
                            <div class="title-holder">
                                <span class="title-large"><?php _e( 'Landing', 'mashup' ); ?></span>
                                <span class="title-small"><?php _e( 'Server Requirements', 'mashup' ); ?></span>
                            </div>
                        </div>
                        <div class="step step-2 col-lg-3 col-md-3 col-sm-12">
                            <div class="title-holder">
                                <span class="title-large"><?php _e( 'Validate', 'mashup' ); ?></span>
                                <span class="title-small"><?php _e( 'Purchase Key', 'mashup' ); ?></span>
                            </div>
                        </div>
                        <div class="step step-3 col-lg-3 col-md-3 col-sm-12">
                            <div class="title-holder">
                                <span class="title-large"><?php _e( 'Import', 'mashup' ); ?></span>
                                <span class="title-small"><?php _e( 'Existing Items', 'mashup' ); ?></span>
                            </div>
                        </div>
                        <div class="step step-4 col-lg-3 col-md-3 col-sm-12">
                            <div class="title-holder">
                                <span class="title-large"><?php _e( 'Done', 'mashup' ); ?></span>
                                <span class="title-small"><?php _e( 'Have Fun', 'mashup' ); ?></span>
                            </div>
                        </div>
                    </div>
                    <div class="importer-steps-containers-wrapper importer-text row">
                        <div class="step-1-container">
                            <div class="col-lg-6 col-md-6 col-sm-12">
                                <h3><?php _e( 'Server Requirements', 'mashup' ); ?></h3>
                                ...
                                <div class="row">
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                        <a href="http://chimpgroup.com/wp-demo/documentation/documentation/mashup-theme-documentation/" class="importer-btn">
                                            <i class="icon-book3"></i>
                                            <?php _e( 'Online Document', 'mashup' ); ?>
                                        </a>	
                                    </div>
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                        <a href="http://chimpgroup.com/support/" class="importer-btn help">
                                            <i class="icon-group"></i>
                                            <?php _e( 'Need Help?', 'mashup' ); ?>
                                        </a>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-6 col-md-6 col-sm-12">
                                <h3><?php _e( 'Plugin Requirements', 'mashup' ); ?></h3>
                                <ul class="importer-requirement">
                                ...
                                <!--
                                <h3><?php _e( 'Reason for giving away', 'mashup' ); ?></h3>
                                <p>
                                <?php _e( 'In order to make our products real worth of your money. We keep improving
									...
									for the product.', 'mashup' ); ?>
                                        
                                </p>

                                <h3><?php _e( 'How you can get free PSD', 'mashup' ); ?></h3>
                                <p>
                                <?php _e( 'Give Review on item which you bought on ThemeForest by going to ThemeForest Downloads section.', 'mashup' ); ?>
                                </p>
                                -->
                        ...
                        <div class="step-2-container validate-purchase-key hidden">
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                <h3><?php _e( 'Purchase code check', 'mashup' ); ?></h3>
                                <p><?php _e( 'Please enter your item purchase code of ChimpStudio', 'mashup' ); ?></p>
                                <?php
                                ...
                                <?php if ( $verify_code ) : ?>
                                    <form role="form">
                                        <div class="control-group">
                                            <label for="item-purchase-code"><?php _e( 'Item Purchase Code', 'mashup' ); ?></label>
                                            <input type="text" name="item-purchase-code" id="item-purchase-code" class="form-contorl">
                                            <label class="purchase-code-error" style="color: #ff0000; display: none;"><?php _e( 'Please provide a valid Item Purchase Code', 'mashup' ); ?></label>
                                            <br>
                                        </div>
                                    </form>
                                <?php else : ?>
                                    <h3 style="color: #069c14;"><?php _e( 'It seems that, you have already verified purchase code. Proceed to next step', 'mashup' ); ?></h3>
                                <?php endif; ?>
                            </div>
                        </div>
                        ...
                        <div class="step-3-container hidden">
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                <div class="sub-step-1">
                                    <h3><?php _e( 'Please choose demo', 'mashup' ); ?></h3>
                                    <p><?php _e( 'Please select a demo to install demo data.', 'mashup' ); ?></p>
                                    <ul class="demos-list importer-list row">
                                        <?php if ( ! empty( $demo_data_structure ) ) : $counter = 0; ?>
                                            ...
                                            <?php endforeach; ?>
                                        <?php else : ?>
                                            <h3><?php _e( 'No demo data\'s defined. :(', 'mashup' ); ?></h3>
                                        <?php endif; ?>
                                    </ul>
                                </div>

                                <div class="sub-step-2 col-lg-5 col-md-5 col-sm-12 col-xs-12 hidden">
                                    <h3><?php _e( 'Select what to import:', 'mashup' ); ?></h3>
                                    <?php
                                    $is_mashup_installed = isset( $plugin_requirements['mashup_var']['is_installed'] ) ? $plugin_requirements['mashup_var']['is_installed'] : false;
                                    ...
                                    <ul class="job-select-demo">
                                        ...
                                        <li class="users-chk-wrapper hidden <?php echo $is_mashup_installed ? '' : 'error'; ?>">
                                            <div class="radiobox">
                                                <input type="checkbox" id="chk-users" value="users" name="chk-users" class="checkbox-data-import-type" <?php echo $is_mashup_installed ? '' : 'disabled="disabled"'; ?>>
                                                <label for="chk-users" class="checkbox-data-import-type">
                                                    <?php _e( 'Users', 'mashup' ); ?>
                                                    <?php echo $is_mashup_installed ? '' : '<br>Please install Mashup Plugin.'; ?>
                                                </label>
                                            </div>
                                        </li>
                                ...
                                <div class="sub-step-3 hidden">
                                    <div class="col-lg-6 col-md-6 col-sm-12">
                                        <h3><?php _e( 'Importing Demo Data:', 'mashup' ); ?></h3>
                        ...
                        <div class="step-4-container importe-success hidden">
                            <div class="col-lg-12">
                                ...
                                <h5><?php _e( 'Congratulations!!!', 'mashup' ); ?></h5>
                                <h1><?php _e( 'Your demo data has been successfully imported.', 'mashup' ); ?></h1>
                            </div>
                        </div>
                    </div>
                    <div class="cs-importer-controls-wrapper">
                        <div class="control-group pull-left">
                            <input type="button" value="<?php _e( 'Previous Step', 'mashup' ); ?>" class="btn-prev-step importer-next-btn pull-left">
                        </div>
                        <div class="control-group pull-right">
                            ...
                            <input type="button" value="<?php _e( 'Next Step', 'mashup' ); ?>" class="btn-next-step importer-next-btn pull-right">
                        </div>
                    </div>
                </div>
            </form>
                        ...
                        if (current_step == 1) {
                            ...
                            if (is_purchase_code_verified || is_purchase_code_already_verified) {
                                ...
                                $.ajax({
                                    ...
                                    "data": {
                                        "action": "mashup_import_demo_data_callback",
                                ...
                                alert("<?php echo __( 'Please provide product purchase code.', 'mashup' ); ?>");
                                change_step = false;
                            }
                        } else if (current_step == 3) {
                            if (selected_demo == "") {
                                alert("<?php echo __( 'Please select a demo.', 'mashup' ); ?>");
                                change_step = false;
                            } else {
                                if (current_sub_step == 1) {
                                    ...
                                    if (queue.length < 1) {
                                        alert("<?php echo __( 'Please select at least one item to import.', 'mashup' ); ?>");
                                        change_step = false;
                                    } else {
...
add_action( 'wp_ajax_mashup_import_demo_data_callback', 'mashup_import_demo_data_callback' );

/**
 * Handle AJAX import demo data calls
 */
function mashup_import_demo_data_callback() {
    $remote_api_url = REMOTE_API_URL;
    $action_type = isset( $_POST['action_type'] ) ? $_POST['action_type'] : '';
    if ( 'import_data' == $action_type ) {
        if ( ! class_exists( 'mashup_Data_Importer' ) ) {
            require_once wp_mashup_framework::plugin_dir() . 'includes/cs-importer/cs-data-importer.php';
        }
        ...
        if ( empty( $selected_demo ) || empty( $import_type ) ) {
            echo __( 'Incomplete requested parameters', 'mashup' );
            wp_die();
        }
        ...
        if ( ! empty( $envato_purchase_code_verification ) ) {
            ...
            if ( isset( $urls[$selected_demo] ) ) {
                ...
                echo json_encode( array( 'success' => false, 'message' => __( 'Sorry, i don\'t have URLs to import for this demo.', 'mashup' ) ) );
                wp_die();
            }
        } else {
            echo json_encode( array( 'success' => false, 'message' => __( 'Sorry, i don\'t have URLs to import.', 'mashup' ) ) );
            wp_die();
        }

        $mashup_importer = new mashup_Data_Importer();
        $mashup_importer->demo_data_name = $selected_demo;
        ...
        if ( 'content' == $import_type ) {
            ...
            $mashup_importer->homepage_slug = $mashup_importer->demo_data_name . '-home';
            $mashup_importer->wp_data_path = isset( $urls['content'] ) ? $urls['content'] : '';
            $mashup_importer->menus_data_path = isset( $urls['menus'] ) ? $urls['menus'] : '';
            $mashup_importer->attachments_path = isset( $urls['attachments'] ) ? $urls['attachments'] : '';
            $mashup_importer->attachments_replace_url = ATTACHMENTS_REPLACE_URL;
            $mashup_importer->is_attachments_zip = true;
            $mashup_importer->is_content = true;
        } elseif ( 'widgets' == $import_type ) {
            $mashup_importer->widget_data_path = isset( $urls['widgets'] ) ? $urls['widgets'] : '';
            $mashup_importer->is_widgets = true;
        } elseif ( 'options' == $import_type ) {
            $mashup_importer->theme_options_data_path = isset( $urls['options'] ) ? $urls['options'] : '';
            $mashup_importer->is_theme_options = true;
        } elseif ( 'users' == $import_type ) {
            $mashup_importer->users_data_path = isset( $urls['users'] ) ? $urls['users'] : '';
            $mashup_importer->is_users = true;
        } elseif ( 'menus' == $import_type ) {
            $mashup_importer->menus_data_path = isset( $urls['menus'] ) ? $urls['menus'] : '';
            $mashup_importer->is_menus = true;
        } elseif ( 'plugins' == $import_type ) {
            $mashup_importer->plugins_data_path = isset( $urls['plugin'] ) ? $urls['plugin'] : '';
            $mashup_importer->is_plugins = true;
        } elseif ( 'rev_slider' == $import_type ) {
            $mashup_importer->sliders_data_path = isset( $urls['sliders'] ) ? $urls['sliders'] : '';
            $mashup_importer->is_sliders = true;
            $mashup_importer->sliders_options = isset( $_POST['other_data'] ) ? $_POST['other_data'] : array( false, false, false );
        }

        $mashup_importer->import();
        ...
        if ( ! empty( $envato_purchase_code_verification ) ) {
            ...
            if ( isset( $urls[$demo_data_name] ) ) {
                ...
                $output['conflicted_pages'] = mashup_get_importer_conflicted_pages( $demo_data_name );
            }
        }
        $is_success = ( empty( $output ) === false );
        echo json_encode( array( 'success' => $is_success, 'output' => $output ) );
    } else {
        echo __( 'Invalid action type.', 'mashup' );
    }
    wp_die();
}

if ( ! function_exists( 'mashup_get_importer_conflicted_pages' ) ) {
     ...
     */
    function mashup_get_importer_conflicted_pages( $demo_data_name ) {
        $output = '';
        $confliced_pages_file = wp_mashup_framework::plugin_dir() . 'includes/cs-importer/conflicts.php';
