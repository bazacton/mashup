<?php
/**
 * Contains mashup_Data_Importer class
 *
 * @since	1.2
 * @package	WordPress
 */
...
/**
 * Class mashup_Data_Importer class
 *
 * @since	1.2
 */
class mashup_Data_Importer {
	/**
	 * Demo data name
	 *
	 ...
	 */
	public $mashup_importer_class_path = '';
	...
	function __construct() {
		...
		$this->mashup_importer_class_path 	= wp_mashup_framework::plugin_dir() . 'includes/cs-importer/wordpress-importer.php';
	}
	 ...
	 * invoke mashup_import_wp_data action
	 */
	function import_wp_data() {
		...
		do_action( 'mashup_import_wp_data', $this );
...
//			$zip->close();
	...
	/**
	 * Import Widgets
	 * invoke mashup_import_widgets
	 */
	function import_widgets() {
		do_action( 'mashup_import_widgets', $this );
	}

	/**
	 * Import Theme Options
	 * invoke mashup_import_theme_options
	 */
	function import_theme_options() {
		do_action( 'mashup_import_theme_options', $this );
	}

	/**
	 * Import Users
	 * invoke mashup_import_users
	 */
	function import_users() {
		do_action( 'mashup_import_users', $this );
	}

	/**
	 * Import Menus and Locations
	 * invoke mashup_import_menus_and_locations
	 */
	function import_menus_and_locations() {
		do_action( 'mashup_import_menus_and_locations', $this );
	}

	/**
	 * Import Plugin Options
	 * invoke mashup_import_plugin_options hook
	 */
	function import_plugin_options() {
		do_action( 'mashup_import_plugin_options', $this );
	}

	/**
	 * Import Sliders
	 * invoke mashup_import_rev_sliders
	 */
	function import_sliders() {
		do_action( 'mashup_import_rev_sliders', $this );
	}

	/**
	 * Set up Pages, set home page for the WP site
	 * invoke mashup_import_setup_pages
	 */
	function set_up_pages() {
		do_action( 'mashup_import_setup_pages', $this );
	}
